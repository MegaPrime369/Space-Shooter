...
class Menu:
    ...
    def create_powerups(self):
        ...
        for path_list in paths.values():
            for path in path_list:
                powerup = PowerUp(price_factor * (powerup_number + 1), path, (50, 50), 'Game Assets/PNG/UI/green_panel.png', self.screen, (95, 200), powers[path], numbers[path])
    ...
    def create_ship(self):
        ...
        for i in range(1, 4):
            for color in ship_color:
                ...
                # Making the ship.
                ship = MenuShip(str((ship_number + 1) * 1000), ship_path, (80, 80), 'Game Assets/PNG/UI/red_panel.png',
                                self.screen, (40, 150))
    ...
    def create_buttons(self):
        ...
        self.ship_left_button = ImageButton(self.screen, left_arrow, button_path, slider_button_size)
        ...
        self.ship_right_button = ImageButton(self.screen, right_arrow, button_path, slider_button_size)
        ...
        self.play_button = Button(self.settings, self.screen, 'PLAY', play_button_size, 
            'uipack_fixed/PNG/blue_button02.png', 25)
